...
@Injectable()
export class WorkflowTestingTypeScriptV2Service {
    private readonly logger = new Logger(WorkflowTestingTypeScriptV2Service.name);
    ...
    async validateAndCleanWorkflow(workflow: OB1Workflow.ValidateWorkflow): Promise<OB1Workflow.ValidateWorkflowRespose> {
        try {
            ...
            workflow.workflowCode = updatedWorkflowCode;
